 ...
 * @author personalc
 */
public class FileSplitAllNew extends FileSplit {
    private static Logger LOG = Logger.getLogger(FileSplitAllNew.class);
    private FileSystem fs = HDFSFileUtil.fileSystem;


    public FileSplitAllNew(String src, String tempPath, String dest, long startPos, long endPos, int threadID, String fileName) {
        super(src, tempPath, dest, startPos, endPos, threadID, fileName);
    }

    public FileSplitAllNew() {
        super();
    }
